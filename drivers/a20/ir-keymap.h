...
static unsigned int ir_keycodes_common[]=
{
	[0x00] = 0xff,
	[0x01] = 0x01,	
	[0x02] = 0x02,	
...
static unsigned int ir_keycodes_black[256]={ KEY_RESERVED };

static unsigned int ir_keycodes_white[256]={ KEY_RESERVED };

#define MAX_CONSTOMER_NUM   2
static const unsigned int* ir_keycodes_contomers[] = {
    ir_keycodes_common,
    ir_keycodes_white,
    ir_keycodes_black,
};
